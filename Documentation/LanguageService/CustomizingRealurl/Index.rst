...
As mentioned before, the Language Service will configure *RealUrl* to properly handle your domains and languages. 
For this purpose, it will adopt the present RealUrl configuration and alteres it to fit your site structure. The 
