...
completely ignore all fields inside the displayed form except *"Config"*:
...
Now what you have to do is to copy all the generated code and paste it into an empty TypoScript file. Afterwards abort 
the backend form for creating a new backend layout record to prevent it from saving into database.
