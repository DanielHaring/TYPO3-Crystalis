...
*(Target version in square brackets)*
 ...
 - [2.0.0] Testing
     ...
     - Ensure queries within Database Service work with non MySQL systems as well
 - [2.0.0] Finish Documentation
     - Document Hooks (/Classes/Service/LanguageService => $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['crystalis']['LanguageService']['registerRewriteConfigurator'])
