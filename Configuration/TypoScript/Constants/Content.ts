  #customcategory=content=LLL:EXT:crystalis/Resources/Private/Language/locallang_be.xlf:constants.category_Content
  #customsubcategory=images=LLL:EXT:crystalis/Resources/Private/Language/locallang_be.xlf:constants.subcategory_Images
  #customsubcategory=media=LLL:EXT:crystalis/Resources/Private/Language/locallang_be.xlf:constants.subcategory_Media

content{

      #cat=content/images/i1; type=int+; label=LLL:EXT:crystalis/Resources/Private/Language/locallang_be.xlf:constants.label_MaxImageWidth
    maxImageWidth = 1600
